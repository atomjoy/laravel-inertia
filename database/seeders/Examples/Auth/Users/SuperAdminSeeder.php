...
class SuperAdminSeeder extends Seeder
{
	...
	{
		if (! User::where('email', 'super@github.com')->first() instanceof User) {
			$user = User::factory()->create([
				'name' => 'Super User',
				'email' => 'super@github.com',
	...
	{
		$role = app(Role::class)->findOrCreate(RolesEnum::SUPERADMIN->value, $guard_name);
		$user->assignRole($role);
	}

	function permissions($user, $guard_name = 'web')
	{
		$permissions = RoleEnum::cases();
